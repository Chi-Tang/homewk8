...
<Form Action=EntLrpz1-89.aspx runat="server"  Method=POST>
 ...
 <script runat="server">
  ...
  Sub LinkButton1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        '' Response.Write(LKGunar)
         ...
         URL = "Excprsn1-89.aspx"
         URL &= "?Name=" & Server.UrlEncode(Name.Text)
         URL &= "&SEX=" & Server.UrlEncode(Sex.SelectedItem.Text)
         URL &= "&HLYR=" & Server.UrlEncode(inpHide.Value)
         URL &= "&LLeap=" & Server.UrlEncode(LLeap.SelectedItem.Text)
         '' URL &= "&LYR=" & Server.UrlEncode(inityr)
         URL &= "&LDY=" & Server.UrlEncode(initdy)
         URL &= "&LDJG=" & Server.UrlEncode(initjg)
         URL &= "&YNUM=" & Server.UrlEncode(YNUM.SelectedItem.Text)
         URL &= "&MNUM=" & Server.UrlEncode(MNUM.SelectedItem.Text)
         URL &= "&DNUM=" & Server.UrlEncode(DNUM.SelectedItem.Text)
         URL &= "&HNUM=" & Server.UrlEncode(HNUM.SelectedItem.Text)
         Server.Transfer( URL )
